...
def select_name_and_motto_of_char_with_longest_motto
  "SELECT MAX(characters.name), characters.motto FROM characters "
end
...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(*) AS character_in FROM character_books
  JOIN characters ON characters.id = character_books.character_id GROUP BY characters.name ORDER BY character_in DESC"
end
