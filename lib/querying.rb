...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(*) AS num_books FROM character_books JOIN characters
  WHERE characters.id = character_books.character_id GROUP BY characters.name ORDER BY num_books DESC;"
end
